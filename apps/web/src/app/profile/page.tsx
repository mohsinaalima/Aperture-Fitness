  ...
  return (
    <AppShell>
      <div className="max-w-[640px] mx-auto space-y-6">
        ...
        {/* Sectioned Settings List (Section 18.12) */}
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <Link href="/login">
              <Button variant="secondary" className="w-full gap-2 text-[14px] text-[var(--color-error)] border-[var(--color-error)]/30 hover:bg-[var(--color-error)]/10">
